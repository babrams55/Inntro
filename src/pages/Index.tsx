...
const Index = () => {
  ...
  return <div className="min-h-screen flex items-center justify-center bg-black">
      <div className="text-center">
        ...
        <h1 className="text-4xl font-bold mb-8 text-white text-center font-['SF Pro Display','sans-serif']">inntro "events"</h1>
        ...
        <div className="space-y-4 w-64 mx-auto">
          <div className="relative">
            ...
            <Button size="icon" onClick={handleSubmitCode} disabled={code.length !== 6} className="absolute right-1 top-1/2 -translate-y-1/2 h-8 w-8 rounded-full bg-blue-600 hover:bg-blue-500">
              <ArrowRight className="h-4 w-4 text-white" />
            </Button>
          </div>
        </div>

        <p className="text-sm text-gray-500 mt-6">Double-date matchmaking </p>
      </div>
    </div>;
};
