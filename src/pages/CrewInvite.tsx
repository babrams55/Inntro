      ...
      <div className="text-center max-w-md px-4">
        ...
        <div className="space-y-4">
          ...
          <Button
            ...
            disabled={!phoneNumber || !gender || !email || !verificationCode || loading}
            className="w-full bg-amber-500 hover:bg-amber-400 text-white rounded-full"
          >
          ...
          <p className="text-sm text-gray-500 mt-4">
            {referralCode ? 
              ...
              "You'll receive a verification code via email to complete signup"}
          </p>
        </div>
      </div>
    </div>
